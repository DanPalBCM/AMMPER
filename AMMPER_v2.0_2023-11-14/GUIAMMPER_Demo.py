...
class SampleApp2(tk.Tk):
    """
    SampleApp2 is a Tkinter-based application class that manages and displays different frames (pages).

    Attributes:
        frames (dict): A dictionary to store instances of different frames, accessible by page names.
    """
    def __init__(self, *args, **kwargs):
        """
        Initializes the SampleApp2 object.
    ...
    def show_frame(self, page_name):
        ...
        Args:
            page_name (str): The name of the frame to be displayed.
        """
...
######################################################33
    ...
    def show_frame(self, page_name):
        """
        Displays the specified frame and hides all other frames.
    ...
    def close(self):
        """
        Closes the application by destroying the Tkinter root window.
        """
        Tk().destroy()
        self.destroy()
...
class StartPage(tk.Frame):
    """
    StartPage is a Tkinter frame class that serves as the initial page for selecting inputs in the application.

    Attributes:
        path (str): The default directory path for storing GUI_MOVIES.
        pathk (str): Intermediate path variable.
        pathkk (str): Intermediate path variable.
    """
    ...
    def RadiationType(self):
        """
        Handles the user's selection of radiation type and updates relevant variables.

        Returns:
            str: The selected radiation type.
        """
    ...
    def RadiationLevel(self):
        """
        Handles the user's selection of radiation level and updates relevant variables.

        Returns:
            str: The selected radiation level path.
        """
        # global output2
    ...
    def CellTypee(self):
        """
        Handles the user's selection of cell type and updates relevant variables.
    ...
    def create_widgets(self):
        """
        Creates input widgets and arranges them in the Tkinter grid.
        """
...
class PLG(tk.Frame):
    """
    PLG is a Tkinter frame class that displays AMMPER results and allows users to interact with the data.

    Attributes:
        controller: The main application controller.
        wentry: Entry widget for user input.
        text: Text widget for displaying results.
        canvas: Canvas widget for displaying images.
        lst: Listbox widget for displaying and interacting with a list of files.
    """
    def __init__(self, parent, controller):
        """
        Initializes the PLG frame.
    ...
    def insertfiles(self):
        """
        Inserts file names into the listbox.
        """
        global pathnn
        print(pathnn)
    ...
    def delete_item(self, event):
        """
        Deletes the selected item from the listbox and its corresponding file.
        """
    ...
    def get_window_size(self):
        """
        Gets the window size for displaying images.
        """
    ...
    def showimg(self, event):
        """
        Displays the selected image from the listbox on the canvas.
        """
        n = self.lst.curselection()
    ...
    def restart(self):
        """
        Restarts the application by refreshing the frame and returning to the StartPage.
        """
        self.refresh()
    ...
    def refresh(self):
        """
        Clears input widgets and text, focusing on another widget to avoid getting stuck in a Text widget.
        """
