...
class Widget(QWidget):
    """
    Represents the main widget for the AMMPER application.

    Attributes:
    - ui: An instance of the Ui_Widget class for managing the user interface.
    - stackedWidget: A widget for managing multiple child widgets.
    - Various attributes for UI elements such as buttons, sliders, labels, and checkboxes.
    """
    ...
    def pushButton_clicked(self):
        """
        Switches the current index of the stacked widget to the second page.
        """
        self.stackedWidget.setCurrentIndex(1)

    def pushButton_2_clicked(self):
        """
        Exits the application and launches the AMMPERCLI script.
        """
        QApplication.exit()
    ...
    def pushButton_3_clicked(self):
        """
        Switches the current index of the stacked widget to the credits page.
        """
        self.stackedWidget.setCurrentIndex(4)

    def pushButton_4_clicked(self):
        """
        Initiates the simulation setup or exits the application based on the display state.
        """
        if self.display:
    ...
    def goBack(self):
        """
        Switches the current index of the stacked widget to the main page.
        """
        self.stackedWidget.setCurrentIndex(0)

    def onRadioButtonClicked(self):
        """
        Handles the radio button clicks and updates related attributes based on the selected option.
        """
    ...
    def Slider(self):
        """
        Handles the slider value changes and updates related attributes accordingly.
        """
        if self.sliderOn:
            self.slider = self.horizontalSlider.value()
            if self.slider == 1:
    ...
    def onRadioButtonClicked2(self):
        """
        Handles the radio button clicks related to cell types and updates the 'cellType' attribute accordingly.
        """
    ...
    def onRadioButtonClicked3(self):
        """
        Handles the radio button clicks related to ROS types and updates the 'ROSType' attribute accordingly.
        Enables the "Set Up Simulation" button.
        """
    ...
    def fileExport(self):
        """
        Handles the state changes of checkboxes related to file export.
        Validates and updates the export path. Sets the 'fileWritten' attribute.
        """
